...
<ul>
{doctors.map((d) => (
<li key={d._id} style={{ marginBottom: 16, border: "1px solid #ddd", padding: 12 }}>
<p><b>Specialty:</b> {d.specialty || "No specialty"}</p>
<p><b>Bio:</b> {d.bio || "No bio"}</p>
<p><b>Doctor UserId:</b> <code>{d.userId}</code></p>
